using hexawware.Api.Installer;
using hexawware.Api.Middleware;
using hexawware.Data.Repositories;
...
using System;
using hexawware.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace hexawware.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "hexawware V1");
        });
