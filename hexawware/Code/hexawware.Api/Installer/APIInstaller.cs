...
using hexawware.Api.Filters;
using hexawware.Business.Installer;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
using Microsoft.Extensions.Logging;

namespace hexawware.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "hexawware API", Version = version + "-" + branch });
        });
